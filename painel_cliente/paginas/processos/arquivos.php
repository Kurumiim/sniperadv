...
$id = filter_var($_POST['id-arquivo'], @FILTER_SANITIZE_STRING);
$nome = filter_var($_POST['nome-arq'], @FILTER_SANITIZE_STRING);
...
$query = $pdo->prepare("INSERT INTO $tabela SET nome = :nome,  data_cad = curDate(), usuario = '$id_usuario', arquivo = :foto, registro = 'Processo', id_reg = :id");
