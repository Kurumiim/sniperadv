...
<div class="justify-content-between">
	...
	<div class="left-content mt-2 mb-3">
		<span style="margin-right: 20px;"><a class="btn ripple btn-primary text-white" onclick="inserir()" type="button"><i class="fe fe-plus me-2 "></i> Adicionar Audiências</a></span>
		...
		<select class="form-control sel50 " aria-label="Default select example" name="usuario_selecionado" id="usuario_selecionado" style="width:230px;" onchange="buscar()">	
				...
				if($nivel_usuario == 'Administrador' || $nivel_usuario == 'Escritório'){
					$query = $pdo->query("SELECT * FROM usuarios where nivel = 'Advogado'");
  ...
  <div class="ocultar_mobile" style="float:left;  margin-top: 25px; margin-left: 15px; width:800px">
  	...
  	<div class="card-group" style="margin-bottom: -30px">
  		...
  		<div class="card text-center mb-5" style="width: 100%; margin-right: 10px; border-radius: 10px; height:110px; box-shadow: 2px 2px 2px 1px rgba(0, 0, 0, 0.1);">		
			<div class="card-header border-light" style="background: #65a964; color:#FFF">
	             Audiências neste mês
	            
	        </div>
	        <div class="card-body">
	        	<p class="card-text" style="margin-top:-15px;">
	        		<h4><span class="" style="color: #65a964;" id="audiencias_mes"></span></h4>
	        	</p>
	        </div>      
    </div>
    ...
    <div class="card text-center mb-5" style="width: 100%; margin-right: 10px; border-radius: 10px; height:110px; box-shadow: 2px 2px 2px 1px rgba(0, 0, 0, 0.1);">	
	        ...
	        <div class="card-body">
	        	<p class="card-text" style="margin-top:-15px;">
	        		<h4><span style="color:#eb3f3f" class="" id="audiencias_hoje"></span></h4>
	        	</p>
	        </div>
    ...
    <div class="card text-center mb-5" style="width: 100%; margin-right: 10px; border-radius: 10px; height:110px; box-shadow: 2px 2px 2px 1px rgba(0, 0, 0, 0.1);">	
	        ...
	        <div class="card-body">
	        	<p class="card-text" style="margin-top:-15px;">
	        		<h4><span style="color:#189ca1" id="audiencias_amanha"></span></h4>
	        	</p>
	        </div>
				...
				<div class="row">
					...
					<div class="row">
						<div class="col-md-12 mb-2">							
								<label>Fórum / Comarca</label>
								<input maxlength="255" type="text" class="form-control" id="forum" name="forum" placeholder="Descrição do local da audiência">							
						</div>
